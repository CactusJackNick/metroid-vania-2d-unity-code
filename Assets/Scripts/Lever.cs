...
public class Lever : MonoBehaviour
{
    ...
    void PullLever() //Actions that happen when pulling the lever
    {
        ...
        PlatScript[2].StartCoroutine("MovePlatform");
       
        PlatScriptRight[0].StartCoroutine("MovePlatformRight");
        PlatScriptRight[1].StartCoroutine("MovePlatformRight");
        PlatScriptRight[2].StartCoroutine("MovePlatformRight");
        PlatScriptRight[3].StartCoroutine("MovePlatformRight");
        PlatScriptRight[4].StartCoroutine("MovePlatformRight");
